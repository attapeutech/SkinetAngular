...
export class CheckoutPaymentComponent implements OnInit {
 ...
 loading = false; //Set loading property to false
  ...
  ngOnInit(): void {
   //Call loadStripe Method
   loadStripe('pk_test_51MjsOBDnj55DZub0SmNQ1nYn9Z2jmzFrrgPZ2FENgLj7fuHYdzCRMqeojaYeulKurytkCJQbmgnyG70CyljjZnMk00Qk4BLKOw').then(stripe => {
    this.stripe = stripe;

...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        signInManager, ITokenService tokenService, IMapper _mapper)
        {
            __mapper = _mapper;
    ...
    public async Task<ActionResult<AddressDto>> GetUserAddress()
    {
        ...
        return __mapper.Map<Address, AddressDto>(user.Address);
    }
    ...
    public async Task<ActionResult<AddressDto>> UpdateUserAddress(AddressDto address)
    {
        ...
        user.Address = __mapper.Map<AddressDto, Address>(address);

        var result = await _userManager.UpdateAsync(user);

        if(result.Succeeded) return Ok(__mapper.Map<Address, AddressDto>(user.Address));
    ...
    {
        //Check email address inside of registerDto
